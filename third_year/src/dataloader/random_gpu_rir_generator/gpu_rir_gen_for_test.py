...
class acoustic_simulator_on_the_fly(simulator_common):
    ...
    def __init__ (self, config):
        ...
        self.params=self.rir_character_dict['gpu_rir_generate_dict'] 
    ...
    def create_rir(self,room_config, num_spk=1, with_coherent_noise=True, mic_type='whole', mic_num='whole'): 
